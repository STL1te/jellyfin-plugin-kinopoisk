...
- Метаданные эпизодов (название, описание, дата выхода) из /seasons
- Поиск персон по имени и биография (факты) персоны
- Похожие фильмы для блока рекомендаций Jellyfin 12

Исправлено: даты вида `1992-03-30` (день рождения и смерти персоны) больше не теряются.
