...
namespace KinopoiskUnofficialInfo.ApiClient
{
    ...
    public partial class Client 
    {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("\u0421\u043b\u0438\u0448\u043a\u043e\u043c \u043c\u043d\u043e\u0433\u043e \u0437\u0430\u043f\u0440\u043e\u0441\u043e\u0432. \u041e\u0431\u0449\u0438\u0439 \u043b\u0438\u043c\u0438\u0442 - 25 \u0437\u0430\u043f\u0440\u043e\u0441\u043e\u0432 \u0432 \u0441\u0435\u043a\u0443\u043d\u0434\u0443", status_, responseText_, headers_, null);
                        }
                        else
                        {
        ...
        public virtual async System.Threading.Tasks.Task<RelatedFilmResponse> RelationsAsync(int id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v2.2/films/{id}/relations");
            urlBuilder_.Replace("{id}", System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// </remarks>
        /// <param name="id">id пользователя на сайте кинопоиск. Может быть строковый</param>
        /// <param name="page">номер страницы</param>
        /// <returns>Запрос выполнен успешно</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<KinopoiskUserVoteResponse> VotesAsync(string id, int? page)
        {
        ...
        /// <returns>Запрос выполнен успешно</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<KinopoiskUserVoteResponse> VotesAsync(string id, int? page, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
    ...
    public enum Type2
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"TOP_100_GREATEST_MOVIES_XXI")]
        TOP_100_GREATEST_MOVIES_XXI = 14,

        [System.Runtime.Serialization.EnumMember(Value = @"PROGRAMMERS_THEME")]
        PROGRAMMERS_THEME = 15,
    ...
    public enum StaffResponseProfessionKey
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"VOICE_MALE")]
        VOICE_MALE = 9,

        [System.Runtime.Serialization.EnumMember(Value = @"VOICE_FEMALE")]
        VOICE_FEMALE = 10,
